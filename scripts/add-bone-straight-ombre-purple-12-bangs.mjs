// Insert the 4x4 HD Lace Bone Straight Wig with Bangs (12" Ombre Purple) into
// MongoDB. Single-length product — no lengthOptions. Two images embedded as
// base64 data URLs. Idempotent — skips if a product with the same `name`
// already exists.
//
// Usage:
//   node scripts/add-bone-straight-ombre-purple-12-bangs.mjs
//
...
const PRODUCT = {
  ...
  description:
    "Raw Hair · Super Double Drawn · Ombre Purple · Bone Straight · With Bangs · 4x4 HD Lace Closure · 12 inches",
  category: "bangs",
  type: "Bone Straight · 4x4 HD Lace · Ombre Purple · Bangs",
  priceCents: 30_000,
  imagePaths: [
    "/products/bone-straight-ombre-purple-12-bangs-a.jpeg",
    "/products/bone-straight-ombre-purple-12-bangs-b.jpeg",
  ],
  stock: 10,
  featured: true,
