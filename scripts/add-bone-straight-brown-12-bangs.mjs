// Insert the 4x4 HD Lace Bone Straight Wig with Bangs (12" Brown) into MongoDB
// under the "bangs" category. Single image embedded as base64 data URL.
// Idempotent — skips if a product with the same `name` already exists.
//
// Usage:
//   node scripts/add-bone-straight-brown-12-bangs.mjs
//
...
const PRODUCT = {
  ...
  description:
    "Raw Hair · Super Double Drawn · Brown · Bone Straight · With Bangs · 4x4 HD Lace Closure · 12 inches",
  category: "bangs",
  type: "Bone Straight · 4x4 HD Lace · Brown · Bangs",
  priceCents: 30_000,
  imagePaths: ["/products/bone-straight-brown-12-bangs-a.jpeg"],
  stock: 10,
  featured: true,
