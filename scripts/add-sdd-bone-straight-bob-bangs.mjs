// Insert the Super Double Drawn Bone Straight Bob Wig with Bangs (100% raw
// human hair). Two length variants: 6" $230, 8" $250. Two images embedded as
// base64 data URLs. Categorized under "bangs". Idempotent — skips if a product
// with the same `name` already exists.
//
// Usage:
//   node scripts/add-sdd-bone-straight-bob-bangs.mjs
...
const PRODUCT = {
  ...
  category: "bangs",
  type: "SDD Bone Straight · Bob · Bangs",
  priceCents: 23_000,
  imagePaths: [
    "/products/sdd-bone-straight-bob-bangs-new-a.jpeg",
    "/products/sdd-bone-straight-bob-bangs-new-b.jpeg",
  ],
  stock: 10,
  featured: true,
