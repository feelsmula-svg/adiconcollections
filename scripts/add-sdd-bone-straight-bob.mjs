// Insert the Super Double Drawn Bone Straight Bob Wig (100% raw human hair).
// Three length variants: 6" $180, 8" $200, 10" $220. Two images embedded as
// base64 data URLs. Idempotent — skips if a product with the same `name`
// already exists.
//
// Usage:
//   node scripts/add-sdd-bone-straight-bob.mjs
...
const PRODUCT = {
  ...
  description: "100% Raw Human Hair",
  category: "wigs",
  type: "SDD Bone Straight · Bob",
  priceCents: 18_000,
  imagePaths: [
    "/products/sdd-bone-straight-bob-a.jpeg",
    "/products/sdd-bone-straight-bob-b.jpeg",
  ],
  stock: 10,
  featured: true,
  badge: { tone: "secondary", label: "Luxury" },
  lengthOptions: [
    { length: '6"', priceCents: 18_000 },
    { length: '8"', priceCents: 20_000 },
    { length: '10"', priceCents: 22_000 },
  ],
};
