// Insert the 5x5 HD Lace Kinky Straight Closure (100% raw Vietnamese single
// donor hair) into MongoDB. Six length variants: 14" $70, 16" $80, 18" $90,
// 20" $110, 22" $125, 24" $145. Image embedded as base64 data URL.
// Categorized under "frontals-and-closures". Idempotent — skips if a product
// with the same `name` already exists.
//
// Usage:
//   node scripts/add-closure-5x5-kinky-straight.mjs
...
const PRODUCT = {
  ...
  type: "5x5 HD Lace Closure · Kinky Straight",
  priceCents: 7_000,
  imagePaths: ["/products/closure-5x5-kinky-straight-a.jpeg"],
  stock: 10,
  featured: true,
