// Insert the SDD Yaki Hair Wig (100% human hair) into MongoDB. Five length
// variants: 20" $280, 22" $320, 24" $360, 26" $420, 28" $470. Image embedded
// as base64 data URL. Idempotent — skips if a product with the same `name`
// already exists.
//
// Usage:
//   node scripts/add-sdd-yaki-wig.mjs
...
const PRODUCT = {
  name: "SDD Yaki Hair Wig",
  description: "100% Human Hair",
  category: "wigs",
  type: "SDD Yaki",
  // Default unit price = lowest length (20"). UI uses lengthOptions for
  // variant pricing.
  priceCents: 28_000,
  imagePaths: ["/products/sdd-yaki-wig-a.jpeg"],
  stock: 10,
  featured: true,
