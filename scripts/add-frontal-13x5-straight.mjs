// Insert the 13x5 HD Lace Straight Frontal (100% raw Vietnamese single donor
// hair) into MongoDB. Six length variants: 14" $80, 16" $90, 18" $100,
// 20" $120, 22" $135, 24" $155. Image embedded as base64 data URL.
// Categorized under "frontals-and-closures". Idempotent — skips if a product
// with the same `name` already exists.
//
// Usage:
//   node scripts/add-frontal-13x5-straight.mjs
...
const PRODUCT = {
  ...
  type: "13x5 HD Lace Frontal · Straight",
  priceCents: 8_000,
  imagePaths: ["/products/frontal-13x5-straight-a.jpeg"],
  stock: 10,
  featured: true,
