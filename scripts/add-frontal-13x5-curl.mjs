// Insert the 13x5 HD Lace Curl Frontal (100% raw Vietnamese single donor
// hair) into MongoDB. Six length variants: 14" $85, 16" $95, 18" $105,
// 20" $125, 22" $140, 24" $160. Image embedded as base64 data URL.
// Categorized under "frontals-and-closures". Idempotent — skips if a product
// with the same `name` already exists.
//
// Usage:
//   node scripts/add-frontal-13x5-curl.mjs
...
const PRODUCT = {
  ...
  type: "13x5 HD Lace Frontal · Curl",
  priceCents: 8_500,
  imagePaths: ["/products/frontal-13x5-curl-a.jpeg"],
  stock: 10,
  featured: true,
