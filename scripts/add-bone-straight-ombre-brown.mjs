// Insert the 5x5 HD Lace Bone Straight Wig (Ombre Brown) — 26" / 32" length
// variants — into MongoDB. Idempotent — skips if a product with the same
// `name` already exists. Image is embedded as a base64 data URL so the record
// is self-contained.
//
// Usage:
//   node scripts/add-bone-straight-ombre-brown.mjs
//
...
const PRODUCT = {
  ...
  description:
    "Raw Hair · Super Double Drawn · Ombre Brown · Bone Straight · 5x5 HD Lace Closure",
  category: "wigs",
  type: "Bone Straight · 5x5 HD Lace · Ombre Brown",
  // Default unit price = lowest length (26"). UI uses lengthOptions for
  // variant pricing.
  priceCents: 72_500,
  imagePaths: ["/products/bone-straight-ombre-brown-5x5-a.jpeg"],
  stock: 10,
  featured: false,
